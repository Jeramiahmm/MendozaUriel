...
export function HeroBackground() {
  ...
  useGSAP(
    () => {
      if (isMobile) {
        // Mobile: only animate 2 flow lines, no wireframe, no parallax
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      {/* Layer 1: 3D Morphing Wireframe — hidden on mobile */}
      {!isMobile && (
        <svg
          ref={wireframeRef}
      ...
      {/* Layer 2: Flowing SVG Lines — reduced to 2 lines on mobile */}
      <svg
